<footer class="text-center lg:text-left bg-gray-100 text-gray-600">
	<div class="mx-6 py-10 text-center md:text-left">
		<div class="grid grid-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
			...
			<div>
				...
				<p class="mb-4">
					<a href="/shop/product1" class="text-gray-600">Household Items</a>
				</p>
				<p class="mb-4">
					<a href="/shop/product2" class="text-gray-600">Interior Decorations</a>
				</p>
				<p class="mb-4">
					<a href="/shop/product1" class="text-gray-600">Men Fashion wears</a>
				</p>
				<p class="mb-4">
					<a href="/shop/product1" class="text-gray-600">Women Fashion wears</a>
				</p>
				<p class="mb-4">
					<a href="/shop/product2" class="text-gray-600">Accessories</a>
				</p>
			</div>
			<div>
	...
	<div class="text-center p-6 bg-gray-200">
		<a href="https://github.com/SwiftMarket">© 2024, Lavandis Lux Lifestyle</a>
	</div>
</footer>
